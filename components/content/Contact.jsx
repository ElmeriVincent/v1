      ...
      <div className="bg-nordpolarnight">
        ...
        <div className="contact-info flex justify-center items-center flex-col lg:mt-auto mt-6">
          ...
          <div className="lg:m-4 text-white font-Poppins text-center mx-2 my-2">
            <p className="lg:text-lg sm:text-base text-sm">
              Contact me if you are interested or just <br /> wanting to discuss
              about tech.
            </p>
            <div className="flex items-center justify-center m-2">
              ...
              <div className="mx-2">
                <p className="text-sm">
                  <span className="font-bold text-sm">Reply time:</span> within
                  1-2 days
                </p>
              </div>
            </div>
            <a
              href="mailto:ElmeriVincent@gmail.com"
              rel="nooperner noreferrer"
              target="_blank">
              <button className="mt-2 bg-nordaurorared rounded-md p-2">
                ElmeriVincent@gmail.com
              </button>
            </a>
          </div>
        </div>
        <div className="socials">
          <div className="flex flex-row text-white text-2xl mx-2 space-x-2 mb-4 items-center justify-center">
            <a
              href="https://github.com/ElmeriVincent"
              target="_blank"
              rel="noopener">
              <AiFillGithub />
            </a>
        ...
        <div className="built-by-elmeri-vincent-keitaanranta">
          <p className="text-white font-Poppins text-xs text-center mb-2">
            ⚒️ Built by Elmeri Vincent Keitaanranta{" "}
          </p>
        </div>
      </div>
    </footer>
