...
export default function Contact() {
    return (
        <section>
            <section id="contact">
                <div className="mt-8">
                    <div className="about-title flex justify-center items-center mt-24 mb-24 flex-col">
                        <h1 className="font-NTR text-3xl border-nordfrostlight border-b border-l px-2 text-white text-right capitalize mt-24 xl:mt-32 mb-4">What's Next ?</h1>
                        ...
                        <p className="text-white font-NTR text-2xl">Looking to hire or wanting to discuss ?</p>
