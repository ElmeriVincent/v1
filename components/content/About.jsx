        ...
        <section>
            <section id="about-section">
                <div className="flex justify-center h-screen items-center flex-col">
                    ...
                    <div className="lg:grid lg:grid-cols-2 mt-12 lg:divide-x lg:divide-dotted lg:text-white">
                        ...
                        <div className="flex justify-center lg:mr-64">
                            <p className=" text-nordfrostice font-NTR text-lg lg:text-xl mx-16 mt-12 whitespace-pre-line">
