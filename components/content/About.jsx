                ...
                <div className="about-title flex justify-center items-center">
                    <div className="max-w-md py-4 px-8 mt-32 rounded-lg my-20 bg-nordpolarevening mx-4">
                        <div className="flex justify-center md:justify-end -mt-16">
                            <img className="w-20 h-20 object-cover rounded-full border-2 border-nordaurorared" src="https://avatars.githubusercontent.com/u/77973084?s=400&u=e059e7e0648f2d9de64b04a5b8c82f6711535e5a&v=4" />
                        </div>
                        <div>
